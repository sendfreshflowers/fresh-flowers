<!-- Form Name -->
<form id = "upload" class="form-horizontal" enctype = "multipart/form-data" method = "POST" action = "addproduct.php">
<fieldset>
...
<div class="form-group">
  ...
  <div class="col-md-4 col-md-push-2">
    <div class="input-group">
      ...
      <input type = "text" id="prependedtext" name="price" class="form-control" placeholder="" pattern = "[0-9].{1,}" required>
    </div>
