...
?>
	<tr style = "font-size:16px;color:#B91845;font-weight:bold">
		...
		<td style = "text-align:center;"><span>&#8377 </span><span id = "net_payable_final"><?php echo $_SESSION['cart_price']; ?></span></td>
	</tr>
<!Coupon Code block>
<?php 
    ...
    <div class="modal-dialog" style = "width:800px;">
        <div class="modal-content" style = "border: 5px solid #f2f2f2;height:490px;">
            ...
            <div class="modal-footer">
				<a href = "index.php" style = "text-decoration:none;color:white"><button type="button" class="btn btn-success" style = "width:220px;font-size:16px;"><span class = "glyphicon glyphicon-chevron-left"></span>Shop More</button></a>
